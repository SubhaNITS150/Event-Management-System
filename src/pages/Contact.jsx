...
export default function Contact() {
  ...
  const handleSubmit = (e) => {
    ...
    emailjs
      .sendForm(
        import.meta.env.VITE_APP_EMAILJS_SERVICE_ID,     // 1. Paste your Service ID here
        import.meta.env.VITE_APP_EMAILJS_TEMPLATE_ID,    // 2. Paste your Template ID here
        formRef.current,
        import.meta.env.VITE_APP_EMAILJS_PUBLIC_KEY      // 3. Paste your Public Key here
      )
      .then(
        (result) => {
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div>
            ...
            <Card className="p-6 bg-white rounded-2xl border border-[#E4E6EB] shadow-sm">
              ...
              {/* IMPORTANT: Add the ref={formRef} here */}
              <form ref={formRef} onSubmit={handleSubmit} className="space-y-4">
                ...
                <div>
                  ...
                  <Input
                    id="name"
                    name="name" // IMPORTANT: Add name attribute
                    value={formData.name}
                    onChange={(e) => setFormData({ ...formData, name: e.target.value })}
                    placeholder="Your name"
                    className="mt-2 border-[#ccd3e0] focus:ring-2 focus:ring-[#003B8E] focus:border-transparent"
