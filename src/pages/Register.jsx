...
// //       setMembers([
// //         ...members,
// //         { id: Date.now(), name: "", email: "", college: "", phone: "" },
// //       ]);
// //     }
// //   };
...
// //       <Navbar />
// //       <main className="flex-1 py-16 bg-card">
...
// //                           className="mt-2"
// //                           required
// //                           data-testid={`input-college-${index}`}
// //                         />
// //                       </div>
// //                       <div>
...
// //             <Card className="p-6 border-chart-3">
// //               <h2 className="font-[Poppins] font-semibold text-2xl mb-6">
// //                 Payment Summary
// //               </h2>
...
// //                   </span>
// //                   <span
// //                     className="font-[Poppins] font-bold text-2xl text-chart-3 flex items-center gap-1"
...
// //               type="submit"
// //               size="lg"
// //               className="w-full bg-chart-3 hover:bg-chart-3 text-white border-chart-3 text-lg"
...
//         <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
//           <div className="text-center mb-12">
//             <h1 className="font-[Poppins] font-bold text-4xl mb-3 text-gray-900">
//               Team Registration
//             </h1>
//             <p className="text-gray-600 text-lg">
//               Register your team for <span className="text-orange-500 font-semibold">Hackathon 2026</span>
//             </p>
//           </div>

//           <form onSubmit={handleSubmit} className="space-y-10">
//             {/* Team Details */}
//             <Card className="p-8 bg-white rounded-xl shadow-md border border-gray-200">
//               <h2 className="font-[Poppins] font-semibold text-2xl mb-6 text-gray-900">
//                 Team Details
//               </h2>
//               <div>
...
//             {/* Payment Summary */}
//             <Card className="p-8 bg-white rounded-xl shadow-md border border-orange-200">
//               <h2 className="font-[Poppins] font-semibold text-2xl mb-6 text-gray-900">
//                 Payment Summary
//               </h2>
...
//                     <IndianRupee className="h-4 w-4 text-orange-500" />2,000
//                   </span>
//                 </div>
//                 <div className="border-t pt-4 flex justify-between items-center">
...
//               type="submit"
//               size="lg"
//               className="w-full bg-orange-500 hover:bg-orange-600 text-white text-lg font-semibold rounded-xl shadow-md"
//             >
//               Proceed to Payment
//             </Button>
//           </form>
