...
//             <h1 className="font-[Poppins] font-bold text-4xl mb-4">Gallery & Sponsors</h1>
//             <p className="text-muted-foreground text-lg">Event highlights and our valued partners</p>
//           </div>

//           <section className="mb-16">
//             <h2 className="font-[Poppins] font-bold text-3xl mb-8 text-center">Our Sponsors</h2>
//             <Card className="p-8">
//               <div className="mb-8">
//                 <h3 className="font-[Poppins] font-semibold text-xl mb-6 text-center">Platinum Sponsors</h3>
...
//                       <div
//                         key={index}
//                         className="h-32 bg-gradient-to-br from-primary/10 to-chart-2/10 rounded-lg flex items-center justify-center hover-elevate border-2 border-primary/20"
//                         data-testid={`sponsor-platinum-${index}`}
//                       >
//                         <span className="font-[Poppins] font-bold text-2xl text-primary">{sponsor.name}</span>
//                       </div>
//                     ))}
//                 </div>
//               </div>
...
//               <div className="mb-8">
//                 <h3 className="font-[Poppins] font-semibold text-xl mb-6 text-center">Gold Sponsors</h3>
...
//                       <div
//                         key={index}
//                         className="h-24 bg-gradient-to-br from-chart-3/10 to-yellow-500/10 rounded-lg flex items-center justify-center hover-elevate border border-chart-3/20"
//                         data-testid={`sponsor-gold-${index}`}
//                       >
//                         <span className="font-[Poppins] font-semibold text-lg text-chart-3">{sponsor.name}</span>
//                       </div>
//                     ))}
//                 </div>
//               </div>
...
//               <div>
//                 <h3 className="font-[Poppins] font-semibold text-xl mb-6 text-center">Silver Sponsors</h3>
...
//                       <div
//                         key={index}
//                         className="h-20 bg-secondary/50 rounded-lg flex items-center justify-center hover-elevate border"
...
//           <section>
//             <h2 className="font-[Poppins] font-bold text-3xl mb-8 text-center">Event Gallery</h2>
...
//             <Card className="p-8 text-center bg-gradient-to-r from-primary/5 to-chart-3/5">
//               <h2 className="font-[Poppins] font-bold text-2xl mb-4">Become a Sponsor</h2>
//               <p className="text-muted-foreground mb-6 max-w-2xl mx-auto">
//                 Partner with us to support talented young programmers and gain visibility among the best coding minds in
//                 India.
//               </p>
//               <Button
//                 size="lg"
//                 className="bg-chart-3 hover:bg-chart-3 text-white border-chart-3"
