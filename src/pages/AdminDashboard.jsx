...
export default function AdminDashboard() {
  ...
  const stats = [
    { icon: Users, value: "234", label: "Registered Teams", color: "text-chart-2", testId: "stat-teams" },
    { icon: FileText, value: "12", label: "Active Questions", color: "text-chart-3", testId: "stat-questions" },
    { icon: Award, value: "89", label: "Certificates Generated", color: "text-chart-4", testId: "stat-certificates" },
  ];

  const teams = [
    { id: "HK2026-001", name: "Code Warriors", members: 3, round1: 85, round2: null, status: "qualified" },
    { id: "HK2026-002", name: "Tech Titans", members: 3, round1: 92, round2: 88, status: "qualified" },
    { id: "HK2026-003", name: "Debug Squad", members: 2, round1: 65, round2: null, status: "eliminated" },
  ];
...
const handleGenerateCertificates = () => {
  ...
  navigate("/certificates"); // 👈 this redirects to the Certificates page
};
  ...
  <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    <div className="mb-8">
      <h1 className="font-[Poppins] font-bold text-4xl mb-2 text-gray-900">Admin Dashboard</h1>
      <p className="text-gray-500">Manage teams, questions, and evaluations</p>
    </div>
  ...
  <TabsContent value="questions" className="mt-6">
    <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
      <h2 className="font-[Poppins] font-semibold text-2xl mb-4">Upload New Question</h2>
  ...
  <TabsContent value="certificates" className="mt-6">
    <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
      <h2 className="font-[Poppins] font-semibold text-2xl mb-4">Generate Certificates</h2>
      <button
      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
        <div className="flex flex-wrap justify-between items-center gap-4 mb-6">
          <h2 className="font-[Poppins] font-semibold text-2xl">Registered Teams</h2>
